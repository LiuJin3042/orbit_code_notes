...
close all
clc
m=importdata('../w4/distf.plt',' ',5);% 6 rows for the column header.
m1=importdata('../w6/distf.plt',' ',5);% 6 rows for the column header.
m2=importdata('../w8/distf.plt',' ',5);% 6 rows for the column header.
m3=importdata('../w10/distf.plt',' ',5);% 6 rows for the column header.
m4=importdata('../w12/distf.plt',' ',5);% 6 rows for the column header.
distf=m.data;
pol=distf(:,1);
thet=distf(:,2);
zet=distf(:,3);
