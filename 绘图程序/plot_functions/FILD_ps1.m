...
%pcolor(X,Y,g);
xlabel('$E/keV$','FontSize',16,'interpreter','latex')
ylabel('$\theta^{o} =\arccos \left( \frac{v_{//}}{v} \right) $','FontSize',16,'interpreter','latex')
set(gca,'FontSize',16)
title([str ', ' str1])
saveas(gcf,'../pictures/angle_E_FILD.fig')
saveas(gcf,'../pictures/angle_E_FILD.png')
%shading interp
%contour(X,Y,g);
%shading interp
