...
contour(X,Y,f);
%shading interp
xlabel('$E/keV$','FontSize',16,'interpreter','latex')
ylabel('$P_{\phi}$','FontSize',16,'interpreter','latex')
saveas(gcf,'../pictures/phi_E_contour.fig')
saveas(gcf,'../pictures/phi_E_contour.png')
...
pcolor(X,Y,g);
xlabel('$E/keV$','FontSize',16,'interpreter','latex')
ylabel('$\lambda=v_{||}/v$','FontSize',16,'interpreter','latex')
saveas(gcf,'../pictures/angle_E_grid.fig')
saveas(gcf,'../pictures/angle_E_grid.png')
%shading interp
%contour(X,Y,g);
%shading interp
