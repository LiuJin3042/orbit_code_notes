...
contour(X,Y,f');
%shading interp
ylabel('$E/keV$','FontSize',16,'interpreter','latex')
xlabel('$P_{\phi}$','FontSize',16,'interpreter','latex')
...
%pcolor(X,Y,g);
ylabel('$E/keV$','FontSize',16,'interpreter','latex')
xlabel('$\theta^{o}=\arccos \left( \frac{v_{//}}{v} \right) $','FontSize',16,'interpreter','latex')
set(gca,'FontSize',16)
title([str ', ' str1])
colorbar
